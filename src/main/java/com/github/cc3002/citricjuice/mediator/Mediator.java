...
public class Mediator {
     ...
     */
    public MediatorWildUnit<Wild> createWildUnit(String name, int hitPoints, int attack, int defense,
                                                 int evasion) {
     ...
     * Creates a new wild unit, adds it to the game and returns the created unit.
     */
    public MediatorBoss<Boss> createBossUnit(String name, int hitPoints, int attack, int defense,
                                          int evasion) {
     ...
     */
    public MediatorPanel<IPanel> setNextPanel(MediatorPanel<IPanel> origin, MediatorPanel<IPanel> target) {
    ...
    public void setPlayerHome(final MediatorPlayer<?> player, final MediatorPanel<?> homePanel) {
        controller.setPlayerHome(player.unit, (PanelHome) homePanel.panel);
    }
